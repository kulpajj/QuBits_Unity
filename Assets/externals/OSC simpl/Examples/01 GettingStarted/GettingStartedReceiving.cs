...
namespace OscSimpl.Examples
{
	public class GettingStartedReceiving : MonoBehaviour
	{
		...
		void OnEnable()
		{
            // NOTE: DO NOT PUT THESE IN THE Update() thread, or each singular message will be received like 150 times
            ...
            oscIn.MapInt("/bang", RandomBangFromMax);
		}
        ...
        void RandomBangFromMax(int bang)
        {
            Debug.Log(bang);
        }
    }
